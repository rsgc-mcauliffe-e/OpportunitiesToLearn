 ...
 */
 ...
 //
 // Video duration, date, location resolution, uncompressed size and camera used
 //
...
struct Video {
	...
	var resolutionY: Int
	var frameRate: Int
	var uncompressedSizeBits: Int {
		return resolutionX*resolutionY*16*frameRate*duration
	}
...
var timelapse = Video(duration: 60, date: "2016-12-13", location: "43.669610, -79.410978", camera: "Google Pixel XL", resolutionX: 1920, resolutionY: 1080, frameRate: 60)
timelapse.uncompressedSize
