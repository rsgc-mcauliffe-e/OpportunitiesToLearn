...
let doStuff1 = ExampleSuperclass(message: "WE MUST RISE UP")
let doStuff2 = ExampleSubclass(message: "☭ AND SEIZE THE MEANS OF PRODUCTION ☭")
doStuff1.doStuff()
doStuff2.doStuff()
...
*/
let goodbye = ExampleSuperclass(message: "☭ OCTOBER 1917 BEST MONTH IN HISTORY ☭")
goodbye.sayGoodbye()
let byebye = ExampleSubclass(message: "THE GENTLE LABOURER SHAL SUFFER NO MORE")
byebye.sayGoodbye()
